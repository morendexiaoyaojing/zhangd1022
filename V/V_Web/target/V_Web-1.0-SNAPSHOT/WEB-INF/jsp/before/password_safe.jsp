    ...
    <menu>
        <div class="container clearfix">
            <ul class="clearfix f_left">
                <li><a href="${pageContext.request.contextPath}/user/loginOut">首页</a></li>
            ...
            <div id="user_bar">
                <a href="user/showMyProfile">
                    ...
                    <c:if test="${not empty user.imgUrl}">
                        <img id="avatar" src="http://localhost:8080/upload/${user.imgUrl}" alt="">
                    </c:if>
            ...
            <div class="proflle_tab_body">
                ...
                <div class="proflle_tab_workplace clearfix">
                    <div class="profile_avatar_area">
                        ...
                        <c:if test="${not empty user.imgUrl}">
                            <img id="avatar" width="180px" height="180px" src="http://localhost:8080/upload/${user.imgUrl}" alt="">
                        </c:if>

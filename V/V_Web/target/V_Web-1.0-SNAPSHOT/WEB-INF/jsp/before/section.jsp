...
<head>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $.post("${pageContext.request.contextPath}/course/updatePlayNum", params);
        });
    </script>
</head>
...
<nav class="w100">
    <div class="container">
        ...
        <ul class="text_13 f_right">
            <li>
                <a href="${pageContext.request.contextPath}/user/loginOut" target="_blank">首页</a>
            </li>
            <li class="nav_down">
        ...
        <div class="container">
            ...
            <c:forEach items="${course.videoList}" var="video">
                <div class="chapter" onclick="load(${video.id})">
                    <p class="biaoti"><a
                            href="${pageContext.request.contextPath}/course/showVideo?videoId=${video.id}&subject_name=${subject_name}">${video.title}</a></p>

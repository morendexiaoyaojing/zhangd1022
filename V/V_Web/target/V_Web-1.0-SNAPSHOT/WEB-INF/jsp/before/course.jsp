...
<nav class="w100">
    <div class="container">
        <img src="${pageContext.request.contextPath}/img/logo.png" alt="Y先生教育的logo" onclick="location.href='${pageContext.request.contextPath}/loginView'"
             draggable="false">
...
<script type="text/javascript">
    ...
    function getVideo(videoId) {
        ...
        if ((null != "${sessionScope.userAccount}" && "${sessionScope.userAccount}" != "") || ($("#isLogin").val() == 1)) {
            //如果登录
            location.href = "${pageContext.request.contextPath}/course/showVideo?videoId=" + videoId + "&subject_name=" + '${subject.subject_name}';
        } else {
            //如果不登录，弹登录框

...
<head>
    ...
    <script type="text/javascript">
        function showAddPage() {
            location.href = "${pageContext.request.contextPath}/getVideoById";
        }
            ...
            Confirm.show('溫馨提示', '您確定要刪除' + name + '嗎？', {
                'Delete': {
                    ...
                    'callback': function () {
                        ...
                        $.post("${pageContext.request.contextPath}/deleteVideo", params, function (data) {
                            if (data == 'success') {
...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <!-- 查询相关组件 -->
            <form class="navbar-form navbar-right" action="${pageContext.request.contextPath}/videoList" method="post">
...
<div class="container" style="margin-top: 20px;">
    ...
    -->
    <form id="form2" action="${pageContext.request.contextPath}/delBatchVideos" method="post">
        <table class="table table-bordered table-hover"
            ...
            <c:forEach items="${page.rows}" var="video" varStatus="status">
                <tr>
                    ...
                    <td><a href="${pageContext.request.contextPath}/getVideoById?id=${video.id}"><span
...
<div class="container">
    <div class="navbar-right" style="padding-right: 17px">
        <p:page url="${pageContext.request.contextPath}/videoList"></p:page>
    </div>
</div>

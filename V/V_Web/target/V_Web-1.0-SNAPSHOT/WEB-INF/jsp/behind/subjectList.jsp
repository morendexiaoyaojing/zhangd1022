...
<head>
    ...
    <script type="text/javascript">
        function showAddPage() {
            location.href = "${pageContext.request.contextPath}/getSubjectById";
        }

        function delSubjectById(Obj, id, name) {
            ...
            Confirm.show('温馨提示：', '确定要删除' + name + '么？', {
                'Delete': {
                    ...
                    'callback': function () {
                        var param = {"id": id};
                        $.post("deleteSubject", param, function (data) {
                            if (data == 'success') {
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse"
            ...
            <ul class="nav navbar-nav">
                <li><a href="${pageContext.request.contextPath}/videoList">视频管理</a></li>
                <li><a href="${pageContext.request.contextPath}/speakerList">主讲人管理</a></li>
                <li class="active"><a href="${pageContext.request.contextPath}/subjectList">课程管理</a></li>
...
<div class="container" style="margin-top: 20px;">
    ...
    <table class="table table-bordered table-hover"
        ...
        <tbody>
        <c:forEach items="${page.rows}" var="subject" varStatus="status">
            <tr>
                <td>${status.index+1}</td>
                <td>${subject.subject_name}</td>
                <td><a href="${pageContext.request.contextPath}/getSubjectById?id=${subject.id}"><span
                        class="glyphicon glyphicon glyphicon-edit" aria-hidden="true"></span></a></td>
                <td><a href="#" onclick="return delSubjectById(this,'${subject.id}','${subject.subject_name}')"><span
...
<div class="container">
    <div class="navbar-right" style="padding-right: 17px">
        <p:page url="${pageContext.request.contextPath}/subjectList"></p:page>
    </div>
</div>
</body>

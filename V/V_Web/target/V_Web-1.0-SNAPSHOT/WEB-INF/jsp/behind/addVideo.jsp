...
<div class="container" style="margin-top: 20px;">
    ...
    <form class="form-horizontal" action="${pageContext.request.contextPath}/updateVideo" method="post">
            ...
            <div class="col-sm-10">
                <div class="input-group">
                    ...
                    <c:if test="${empty video.speaker_id}">
                        <input type="hidden" class="form-control" id="speaker_id" name="speaker_id" value="0">
                    </c:if>
            ...
            <div class="col-sm-10">
                <div class="input-group">
                    ...
                    <c:if test="${not empty video.course_id}">
                        <input type="hidden" class="form-control" id="course_id" name="course_id" value="${video.course_id}">
                    </c:if>

...
<head>
    ...
    <script type="text/javascript">
        function showAddPage() {
            location.href = "${pageContext.request.contextPath}/getSpeakerById";
        }
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse"
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="${pageContext.request.contextPath}/speakerList">主讲人管理</a></li>
    ...
    <table class="table table-bordered table-hover"
        ...
        <c:forEach items="${page.rows}" var="speaker" varStatus="status">
            <tr>
                ...
                <td><a href="${pageContext.request.contextPath}/getSpeakerById?id=${speaker.id}"><span
...
<div class="container">
    <div class="navbar-right" style="padding-right: 17px">
        <p:page url="${pageContext.request.contextPath}/speakerList"></p:page>
    </div>
</div>
</body>

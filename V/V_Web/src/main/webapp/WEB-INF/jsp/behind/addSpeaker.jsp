    ...
    <script type="text/javascript">
        ...
        function showName(obj, id, type) {
            ...
            if (type == 1) {
                ...
                // 将获取的值显示在输入框内
                $("#speaker_name").val(chooseName);
                //想给隐藏的文本赋值
                $("#speaker_id").val(id);
            } else {
                var chooseName = $(obj).text();
                // 将获取的值显示在输入框内
                $("#course_name").val(chooseName);
                //想给隐藏的文本赋值
                $("#course_id").val(id);
            }
...
<div class="container" style="margin-top: 20px;">
    ...
    <form class="form-horizontal" action="${pageContext.request.contextPath}/updateSpeaker" method="post">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" name="speakerName" value="${speaker.speaker_name}" placeholder="主讲人名称">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" name="speakerJob" class="form-control" value="${speaker.speaker_job}" placeholder="主讲人职位">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <textarea class="form-control" name="speakerDesc" rows="3">${speaker.speaker_desc}</textarea>
            </div>
        </div>
